import { decrementTime } from './functions/decrement-time'
import { divide } from './functions/divide'
import { incrementTime } from './functions/increment-time'
import { multiply } from './functions/multiply'
import { removeChars } from './functions/remove-chars'
import { removeSpaces } from './functions/remove-spaces'
import { replace } from './functions/replace'
import { subtract } from './functions/subtract'
import { sum } from './functions/sum'
import type { CalcOpt } from './types'
import { Validator } from './validator'

export class Utils {
  private static instance: Utils
  private static validator: Validator = Validator.create()

  private constructor() {
    Utils.validator = Validator.create()
  }
  ...
  number(target: number) {
    return {
       ...
       * @summary If you provide a string NAN (not a number) 0 will be considered as value.
       */
  ...
  string(target: string) {
    return {
       ...
       * @param value character or word to be applied.
